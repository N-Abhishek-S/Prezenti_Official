...
import type { StaffingPricingCategory } from './staffingPricingData';

interface ServiceCategoryRowProps {
  category: StaffingPricingCategory;
}
  ...
  return (
    <div>
      ...
      <div className="pricing-reveal mb-6">
        <h3 className="text-2xl font-extrabold text-[#0D1F1A]">{category.label}</h3>
