      ...
      <div className="mx-auto max-w-7xl px-6">
        <motion.div variants={fadeUp} className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          <div>
            ...
            <h2 className="mb-4 text-[30px] font-semibold">{locationAvailability.label}</h2>
          ...
          <div className="overflow-hidden rounded-[28px] border border-neutral-200 bg-white shadow-[0_30px_90px_rgba(10,42,34,0.08)]">
            <div className="grid md:grid-cols-[1fr_1.08fr]">
              <div className="border-b border-neutral-100 p-8 md:border-b-0 md:border-r">
                ...
                <h3 className="text-3xl font-semibold text-neutral-950">{locationAvailability.city}</h3>
